...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(NRF_SCN_GPIO_Port, NRF_SCN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : NRF_SCN_Pin */
  GPIO_InitStruct.Pin = NRF_SCN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(NRF_SCN_GPIO_Port, &GPIO_InitStruct);
