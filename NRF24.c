...
void nrf24_enhance_tx_pwr(uint8_t en){
	uint8_t data = 0;
...
void nrf24_mask_it(uint8_t maskRx, uint8_t maskTx, uint8_t maskMaxRt){
	uint8_t data;
	data = nrf24_r_reg(CONFIG, 1);
	if(maskRx){
		data |= (1 << MASK_RX_DR);
...
void nrf24_clear_all_it_flag(void){
	nrf24_clear_rx_dr();
	nrf24_clear_tx_ds();
	nrf24_clear_max_rt();
}

void nrf24_start(uint8_t mode){
	...
	nrf24_mask_it(NRF24_MASK_IRQ_RX_DR, NRF24_MASK_IRQ_TX_DS, NRF24_MASK_IRQ_MAX_RT);

	nrf24_auto_ack_all(NRF24_AUTO_ACK);
	nrf24_en_ack_pld(NRF24_EN_ACK_PLD);
	nrf24_dpl(NRF24_ENABLE_DPL);

	nrf24_set_crc(NRF24_EN_CRC, NRF24_CRC_LENGTH);

	nrf24_tx_pwr(NRF24_TX_POWER);
	nrf24_enhance_tx_pwr(NRF24_ENHANCE_TX_PWR);
	nrf24_data_rate(NRF24_DATA_RATE);
	nrf24_set_channel(NRF24_CHANNEL);
	nrf24_set_addr_width(NRF24_ADDR_WIDTH);

	nrf24_set_rx_dpl(0, NRF24_ENABLE_DPL);
	nrf24_set_rx_dpl(1, NRF24_ENABLE_DPL);
	nrf24_set_rx_dpl(2, NRF24_ENABLE_DPL);
	nrf24_set_rx_dpl(3, NRF24_ENABLE_DPL);
	nrf24_set_rx_dpl(4, NRF24_ENABLE_DPL);
	nrf24_set_rx_dpl(5, NRF24_ENABLE_DPL);

	nrf24_pipe_pld_size(0, PLD_S);

	nrf24_auto_retr_delay(NRF24_AUTO_RETR_DELAY);
	nrf24_auto_retr_limit(NRF24_AUTO_RETR_LIMIT);
