 ...
 * Mask interrupts
 *
 * maskRx: 1 to mask RX_DR interrupt
 * maskTx: 1 to mask TX_DS interrupt
 * maskMaxRt: 1 to mask MAX_RT interrupt
 */
void nrf24_mask_it(uint8_t maskRx, uint8_t maskTx, uint8_t maskMaxRt);

/*
 * Start and config nrf24
 * mode: 1 for TX mode
 */
void nrf24_start(uint8_t mode);

/*
 * Enable or disable enhanced TX power
 */
